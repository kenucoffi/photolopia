    ...
    return (
        ...
        <div className="hidden md:block">
            <div className="fixed top-18 left-0 px-10  py-10 h-[75%] z-50  bg-gray-100/80 backdrop-blue-md  overflow-y-scroll ">
                <div className="flex flex-col  my-3 ml-3">
                    ...
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/profile">profile</Link></div>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/photographers">Event type</Link></div>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/photographers">rating</Link></div>
        ...
        <div className="md:hidden">
            <div className="fixed top-18 left-0 px-6  h-[75%] z-50  bg-gray-100/80 backdrop-blue-md shadow-xl shadow-blue-300   ">
                    ...
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl ">packeges</div>
                    <hr className="my-2 "/>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/profile">Update Profile</Link></div>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/photographers">Event type</Link></div>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl "><Link href="/photographers">rating</Link></div>
                    <div className="px-2 py-2 font-bold text-gray-500 text-lg cursor-pointer hover:bg-white hover:text-blue-300 rounded-xl ">contacts</div>
